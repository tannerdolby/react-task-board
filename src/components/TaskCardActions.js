...
import { saveItemToColumn, saveCurrentDraggedTask, saveIsExpandingTask, removeTask, setStoredTasks, saveToLocalStorage } from "../redux/features/task-board-slice";
...
export default function TaskCardActions({}) {
    ...
    return (
        <div className="task-card-actions">
            ...
            <button className="delete-task-btn" title="delete task" onClick={(e) => {
